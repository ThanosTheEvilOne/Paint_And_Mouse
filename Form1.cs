...
namespace WindowsForms_11_PaintAndMouse
{
    public partial class Form1 : Form
    {
        Point piste = new Point(0, 0); //Referenssi piste
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            void DrawCordinates(Graphics Graf) // Piirretään piikoordinaattien arvot näytölle.
            {
        ...
        private void Form1_MouseDown(object sender, MouseEventArgs e) //hiiri alas
        {
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e) // nappia painatessa
        {
            if (e.KeyCode == Keys.Up) { piste.Y -= 5;Refresh(); }
            else if(e.KeyCode == Keys.Down) { piste.Y += 5; Refresh(); }
            else if (e.KeyCode == Keys.Left) { piste.X -= 5; Refresh(); }
            else if(e.KeyCode == Keys.Right){ piste.X += 5; Refresh(); }
        }
    }
}
